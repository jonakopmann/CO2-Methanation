...
class Integrator:
    ...
    def run(self):
        ...
        alg_co2 = self.params.y_co2_0 + self.params.delta_y * ca.sin(2 * ca.pi * self.params.f * t) - y_co2_surf
        alg_h2 = self.params.y_h2_0 + self.params.delta_y * ca.sin(2 * ca.pi * self.params.f * t) - y_h2_surf
        alg_ch4 = self.params.y_ch4_0 + self.params.delta_y * ca.sin(2 * ca.pi * self.params.f * t) - y_ch4_surf
        alg_h2o = self.params.y_h2o_0 + self.params.delta_y * ca.sin(2 * ca.pi * self.params.f * t) - y_h2o_surf
        ...
        dae = {
            ...
            'z': ca.vertcat(y_co2_surf, y_h2_surf, y_ch4_surf, y_h2o_surf),
            't': t,
            'ode': ca.vertcat(ode_co2, ode_h2, ode_ch4, ode_h2o),
            'alg': ca.vertcat(alg_co2, alg_h2, alg_ch4, alg_h2o)
        }
        ...
        # integrate
        res_dic = integrator(x0=x0, z0=ca.vertcat(self.params.y_co2_0, self.params.y_h2_0, self.params.y_ch4_0,
                                                 self.params.y_h2o_0))
        ...
        # res_T_i = res[1]
        plotter = Plotter()
        plotter.plot(self.params.t_i, np.linspace(0, self.params.r_max, self.params.r_steps), res_y_co2.full(),
                     't / s', 'r / mm', 'y_co2', 'Test')
