...
class Context:
    def __init__(self, params: Parameters):
        ...
        self.y_h2o_fl = w_to_y(self.w_h2o_fl, self.params.M_h2o, self.M_fl)
        ...
        D_h2o_m = DiffusionCoefficient.get_D_i_m(self.y_h2o, self.y_co2, self.y_ch4,
                       self.y_h2, D_co2_h2o, D_ch4_h2o, D_h2_h2o)
        ...
        D_h2o_kn = DiffusionCoefficient.get_D_i_Kn(self, self.params.M_h2o)
        ...
        self.D_h2o_eff = self.params.epsilon / self.params.tau_sq * (1 / D_h2o_m + 1 / D_h2o_kn) ** -1
        ...
        Sc_h2o = nu_fl / D_h2o_m[-1]
        Sh_h2o = 2 + 0.6 * Re ** 0.5 + Sc_h2o ** (1 / 3)
        self.beta_h2o = Sh_h2o * D_h2o_m[-1] / (2 * self.params.r_max)  # [mm/s]
