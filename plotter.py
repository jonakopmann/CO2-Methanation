...
class Plotter:
    def __init__(self, t, r, res_final, params: Parameters):
        ...
        self.w_h2o = ca.vertcat(res_x[2], res_z[2]).full()
        self.w_ch4 = ca.vertcat(res_x[1], res_z[1]).full()
        self.w_h2 = 1 - self.w_co2 - self.w_h2o - self.w_ch4
    ...
    def plot_closing_condition(self):
        ...
        np.save('/home/jona/PycharmProjects/CO2-Methanisation/h2_data_co2.npy', self.w_co2[:, t])
        np.save('/home/jona/PycharmProjects/CO2-Methanisation/h2_data_h2.npy', self.w_h2[:, t])
        np.save('/home/jona/PycharmProjects/CO2-Methanisation/h2_data_ch4.npy', self.w_ch4[:, t])
        np.save('/home/jona/PycharmProjects/CO2-Methanisation/h2_data_h2o.npy', self.w_h2o[:, t])
